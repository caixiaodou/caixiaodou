<?php
	...
	class CartTool{
		...
		// //处理购物车
		// public function fitItem($){
		// 	$i=0;
		// 	foreach(  as $arr){

		// 		$arrItem['productId']    =$arr['productId'];
		// 		$arrItem['productName']  =$arr['productName'];
		// 		$arrItem['productPrice'] =$arr['productPrice'];
		// 		$arrItem['productNum']   =$arr['productNum'];
		// 		$arrItem['priceTotal']   =$arr['productPrice']*$item['productNum'];

		// 		$this->items[$i]=$arrItem;
		// 		$i++;
		// 	}
		// }
